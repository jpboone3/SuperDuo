...
public class scoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        byte[] crest = cursor.getBlob(COL_HOME_CREST);
        Drawable drawable = null;
        if (crest != null) {

            ByteArrayInputStream imageStream = new ByteArrayInputStream(crest);
            SVG svg = null;
            try {
        ...
        if (drawable != null){
            ...
            mHolder.home_crest.setImageDrawable(drawable);
        }
        crest = cursor.getBlob(COL_AWAY_CREST);
        drawable = null;
        if (crest != null) {
            ...
            try {
                ...
                //Log.d(myFetchService.LOG_TAG,"SVG Conversion exception: " + e.toString());
            }
            if (svg != null)
                drawable = svg.createPictureDrawable();
        }
        if (drawable != null){
            ...
            mHolder.away_crest.setImageDrawable(drawable);
        }
